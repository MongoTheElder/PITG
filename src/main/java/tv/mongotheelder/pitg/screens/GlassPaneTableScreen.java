...
public class GlassPaneTableScreen extends ContainerScreen<GlassPaneTableContainer> {
    private float scrollOffs;
    private boolean scrolling;
    private int startIndex;
    private boolean displayRecipes;

    public GlassPaneTableScreen(GlassPaneTableContainer p_i51076_1_, PlayerInventory p_i51076_2_, ITextComponent p_i51076_3_) {
    ...
    protected void renderBg(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
        ...
        this.minecraft.getTextureManager().bind(Pitg.GLASS_PANE_TABLE_GUI_TEXTURE);
        int i = this.leftPos;
        int j = this.topPos;
    ...
    protected void renderTooltip(MatrixStack p_230459_1_, int p_230459_2_, int p_230459_3_) {
        ...
        if (this.displayRecipes) {
            ...
            List<GlassPaneTableRecipe> list = this.menu.getRecipes();
